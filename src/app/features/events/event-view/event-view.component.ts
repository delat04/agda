...
@Component({
  ...
  template: `
    <div class="font-[syne] bg-gradient-to-br from-gray-50 to-indigo-50 min-h-screen py-8">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div *ngIf="!loading && !error && event" class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
          ...
          <!-- Event Images -->
          <div *ngIf="event.images && event.images.length > 0" class="relative">
            <!-- Main image -->
          ...
          <div class="p-8">
            ...
            <!-- Tags -->
            <div *ngIf="event.tags && event.tags.length > 0" class="flex flex-wrap gap-2 mb-6">
              <span
            ...
            <!-- Location -->
            <div *ngIf="event.location" class="bg-gray-50 p-4 rounded-lg mb-6">
              <div class="flex items-start">
                <div class="flex-shrink-0 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Attendees -->
            <div *ngIf="event.attendees !== undefined || event.maxAttendees !== undefined" class="bg-gray-50 p-4 rounded-lg mb-6">
              <div class="flex items-start">
                <div class="flex-shrink-0 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Description -->
            <div *ngIf="event.description" class="mb-8">
            ...
            <!-- Additional Details -->
            <div *ngIf="event.organizer || event.contactEmail || event.isPublic !== undefined" class="border-t border-gray-200 pt-6 mb-6">
              ...
              <div *ngIf="event.updatedAt && event.updatedAt !== event.createdAt" class="flex items-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Action Buttons -->
            <div class="flex flex-wrap justify-end space-x-0 sm:space-x-4 space-y-3 sm:space-y-0 mt-8 pt-6 border-t border-gray-200">
              <button *ngIf="isUpcoming(event)" class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors mr-0 sm:mr-auto">
              ...
              <button
                ...
                class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                (click)="deleteEvent()"
                class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-red-700 bg-red-100 rounded-md hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
